...
public class EzyPaySubscriptionAppExample {

    private final Logger logger = LoggerFactory.getLogger(EzyPaySubscriptionAppExample.class);

    public static void main(String[] args) {
        SpringApplication.run(EzyPaySubscriptionAppExample.class, args);
    }
    ...
    static class OAuth2SecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            ...
            http
                ...
                .and()
                   .authorizeRequests()
                		.antMatchers(HttpMethod.GET,"/", "/custom-login", "/css/**", "/images/**").permitAll()
