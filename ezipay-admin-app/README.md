...
```bash
cd custom-login
mvn -Dokta.oauth2.issuer=https://dev-11029663.okta.com/oauth2/default \
    -Dokta.oauth2.clientId=0oa183vrq0REy8Vc45d7 \
    -Dokta.oauth2.clientSecret=ZnZuIo9NUXTZ35UnppB8Reg-r0TQ6QFYz2P4VeKx
```
...
```bash
export OKTA_OAUTH2_ISSUER=https://dev-11029663.okta.com/oauth2/default
export OKTA_OAUTH2_CLIENT_ID=0oa183vrq0REy8Vc45d7
export OKTA_OAUTH2_CLIENT_SECRET=ZnZuIo9NUXTZ35UnppB8Reg-r0TQ6QFYz2P4VeKx
```
